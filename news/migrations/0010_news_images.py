...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for news_item in orm.News.objects.all():
            news_image = orm.NewsImage(news=news_item, image=news_item.image)
            news_image.save()


    def backwards(self, orm):
        "Write your backwards methods here."
        for news_image in orm.NewsImage.objects.all():
            news_item = news_image.news
            news_item.image = news_image.image
            news_item.save()
