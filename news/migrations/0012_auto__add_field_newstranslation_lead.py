...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsTranslation.lead'
        db.add_column(u'news_news_translation', 'lead',
                      self.gf('ckeditor.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewsTranslation.lead'
        db.delete_column(u'news_news_translation', 'lead')
