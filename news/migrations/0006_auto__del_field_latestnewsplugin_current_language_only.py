...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LatestNewsPlugin.current_language_only'
        db.delete_column(u'news_latestnewsplugin', 'current_language_only')


    def backwards(self, orm):
        # Adding field 'LatestNewsPlugin.current_language_only'
        db.add_column(u'news_latestnewsplugin', 'current_language_only',
