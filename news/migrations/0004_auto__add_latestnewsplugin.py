...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'news_latestnewsplugin', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('limit', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('current_language_only', self.gf('django.db.models.fields.BooleanField')()),
        ))
        db.send_create_signal(u'news', ['LatestNewsPlugin'])


    def backwards(self, orm):
        # Deleting model 'LatestNewsPlugin'
        db.delete_table(u'news_latestnewsplugin')
